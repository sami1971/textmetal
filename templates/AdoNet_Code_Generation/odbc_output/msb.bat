...
"%BUILD_EXE%" ".\src\TextMetal.WebHostSample.Objects.Model.sln" /t:clean /p:Configuration=%BUILD_TOOL_CFG%
IF %ERRORLEVEL% NEQ 0 goto pkgError

"%BUILD_EXE%" ".\src\TextMetal.WebHostSample.Objects.Model.sln" /t:build /p:Configuration=%BUILD_TOOL_CFG% > _msbuild_log.txt
IF %ERRORLEVEL% NEQ 0 goto pkgError
