...
{
	public partial class SqlFileConnectionUIControl
	{
		/// <summary> 
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SqlFileConnectionUIControl));
			...
			this.databaseFileTextBox.Leave += new System.EventHandler(this.UpdateDatabaseFile);
			...
			this.Name = "SqlFileConnectionUIControl";
