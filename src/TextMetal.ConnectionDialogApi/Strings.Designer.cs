...
namespace TextMetal.ConnectionDialogApi {
    ...
    internal class Strings {
        ...
        internal static global::System.Resources.ResourceManager ResourceManager {
            get {
                if (object.ReferenceEquals(resourceMan, null)) {
					global::System.Resources.ResourceManager temp = new global::System.Resources.ResourceManager("TextMetal.ConnectionDialogApi.Strings", typeof(Strings).Assembly);
                    resourceMan = temp;
                }
                return resourceMan;
            }
		...
		/// <summary>
		///   Looks up a localized string similar to .NET Framework Data Provider for SQL Compact Edition.
		/// </summary>
		internal static string DataProvider_SqlCe
		{
			get
			{
				return ResourceManager.GetString("DataProvider_SqlCe", resourceCulture);
			}
		}

		/// <summary>
		///   Looks up a localized string similar to Use this selection to connect to Microsoft SQL Compact Edition 3.5 SP2 or above using the .NET Framework Data Provider for SQL Compact Edition..
		/// </summary>
		internal static string DataProvider_SqlCe_DataSource_Description
		{
			get
			{
				return ResourceManager.GetString("DataProvider_SqlCe_DataSource_Description", resourceCulture);
			}
		}

		/// <summary>
		///   Looks up a localized string similar to Use this data provider to connect to Microsoft SQL Compact Edition 3.5 SP2 or above..
		/// </summary>
		internal static string DataProvider_SqlCe_Description
		{
			get
			{
				return ResourceManager.GetString("DataProvider_SqlCe_Description", resourceCulture);
			}
		}

		/// <summary>
		///   Looks up a localized string similar to Use this selection to attach a database file to a local Microsoft SQL Compact Edition file using the .NET Framework Data Provider for SQL Compact Edition..
		/// </summary>
		internal static string DataProvider_SqlCe_FileDataSource_Description
		{
			get
			{
				return ResourceManager.GetString("DataProvider_SqlCe_FileDataSource_Description", resourceCulture);
			}
		}
		...
		///   Looks up a localized string similar to SqlClient.
		/// </summary>
		internal static string DataProvider_SqlCe_Short
		{
			get
			{
				return ResourceManager.GetString("DataProvider_SqlCe_Short", resourceCulture);
			}
		}
		...
		/// <summary>
		///   Looks up a localized string similar to Microsoft SQL Compact Edition.
		/// </summary>
		internal static string DataSource_MicrosoftSqlCe
		{
			get
			{
				return ResourceManager.GetString("DataSource_MicrosoftSqlCe", resourceCulture);
			}
		}
