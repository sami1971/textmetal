...
{
	public class OdbcSchemaSourceStrategy : SourceStrategy
	{
		...
		private static string GetAllAssemblyResourceFileText(string folder, string name)
		{
			string resourcePath;
			Type targetType;
			string sqlText = null;
			...
			targetType = typeof(OdbcSchemaSourceStrategy);
			resourcePath = string.Format("{0}.DML.{1}.{2}.sql", targetType.Namespace, folder, name);
		...
		private static Type InferClrTypeForSqlType(string dataSourceTag, string sqlType)
		{
			if (dataSourceTag.SafeToString().ToLower() == "sqlserver")
			{
			...
			else if (dataSourceTag.SafeToString().ToLower() == "sybaseiq")
			{
			}
		...
		protected override object CoreGetSourceObject(string sourceFilePath, IDictionary<string, IList<string>> properties)
		{
			...
			return this.GetSchemaModel(connectionString, dataSourceTag);
		}

		private object GetSchemaModel(string connectionString, string dataSourceTag)
		{
			Type connectionType = typeof(OdbcConnection);
			Database database;
			int recordsAffected;
			...
			using (UnitOfWorkContext unitOfWorkContext = UnitOfWorkContext.Create(connectionType, connectionString, false))
			{
				...
				var dataReaderDatabase = unitOfWorkContext.ExecuteDictionary(CommandType.Text, GetAllAssemblyResourceFileText(dataSourceTag, "Database"), null, out recordsAffected);
				{
				...
				var dataReaderSchema = unitOfWorkContext.ExecuteDictionary(CommandType.Text, GetAllAssemblyResourceFileText(dataSourceTag, "Schemas"), null, out recordsAffected);
				{
					if ((object)dataReaderSchema != null)
					{
						foreach (var drSchema in dataReaderSchema)
						{
							...
							var dataReaderTable = unitOfWorkContext.ExecuteDictionary(CommandType.Text, GetAllAssemblyResourceFileText(dataSourceTag, "Tables"), new IDataParameter[] { unitOfWorkContext.CreateParameter(ParameterDirection.Input, DbType.String, 100, 0, 0, true, "@P1", schema.SchemaName), unitOfWorkContext.CreateParameter(ParameterDirection.Input, DbType.String, 100, 0, 0, true, "@P2", schema.SchemaName) }, out recordsAffected);
							{
								foreach (var drTable in dataReaderTable)
								{
									...
									var dataReaderColumn = unitOfWorkContext.ExecuteDictionary(CommandType.Text, GetAllAssemblyResourceFileText(dataSourceTag, "Columns"), new IDataParameter[]
									                                                                                                                        {
									...
									var dataReaderForeignKey = unitOfWorkContext.ExecuteDictionary(CommandType.Text, GetAllAssemblyResourceFileText(dataSourceTag, "ForeignKeys"), new IDataParameter[]
									                                                                                                                                {
									                                                                                                                                	unitOfWorkContext.CreateParameter(ParameterDirection.Input, DbType.String, 100, 0, 0, true, "@P1", schema.SchemaName),
									                                                                                                                                	unitOfWorkContext.CreateParameter(ParameterDirection.Input, DbType.String, 100, 0, 0, true, "@P2", table.TableName)
									                                                                                                                                }, out recordsAffected);
									{
										if ((object)dataReaderForeignKey != null)
										{
											foreach (var drForeignKey in dataReaderForeignKey)
											{
												...
												var dataReaderForeignKeyColumn = unitOfWorkContext.ExecuteDictionary(CommandType.Text, GetAllAssemblyResourceFileText(dataSourceTag, "ForeignKeyColumns"), new IDataParameter[]
												                                                                                                                                            {
												                                                                                                                                            	unitOfWorkContext.CreateParameter(ParameterDirection.Input, DbType.String, 100, 0, 0, true, "@P1", schema.SchemaName),
												                                                                                                                                            	unitOfWorkContext.CreateParameter(ParameterDirection.Input, DbType.String, 100, 0, 0, true, "@P2", table.TableName),
									...
									var dataReaderUniqueKey = unitOfWorkContext.ExecuteDictionary(CommandType.Text, GetAllAssemblyResourceFileText(dataSourceTag, "UniqueKeys"), new IDataParameter[]
									                                                                                                                              {
									                                                                                                                              	unitOfWorkContext.CreateParameter(ParameterDirection.Input, DbType.String, 100, 0, 0, true, "@P1", schema.SchemaName),
									                                                                                                                              	unitOfWorkContext.CreateParameter(ParameterDirection.Input, DbType.String, 100, 0, 0, true, "@P2", table.TableName)
									                                                                                                                              }, out recordsAffected);
									{
										if ((object)dataReaderUniqueKey != null)
										{
											foreach (var drUniqueKey in dataReaderUniqueKey)
											{
												...
												var dataReaderUniqueKeyColumn = unitOfWorkContext.ExecuteDictionary(CommandType.Text, GetAllAssemblyResourceFileText(dataSourceTag, "UniqueKeyColumns"), new IDataParameter[]
												                                                                                                                                          {
												                                                                                                                                          	unitOfWorkContext.CreateParameter(ParameterDirection.Input, DbType.String, 100, 0, 0, true, "@P1", schema.SchemaName),
												                                                                                                                                          	unitOfWorkContext.CreateParameter(ParameterDirection.Input, DbType.String, 100, 0, 0, true, "@P2", table.TableName),
							...
							var dataReaderProcedure = unitOfWorkContext.ExecuteDictionary(CommandType.Text, GetAllAssemblyResourceFileText(dataSourceTag, "Procedures"), new IDataParameter[] { unitOfWorkContext.CreateParameter(ParameterDirection.Input, DbType.String, 100, 0, 0, true, "@P1", schema.SchemaName) }, out recordsAffected);
							{
								if ((object)dataReaderProcedure != null)
								{
									foreach (var drProcedure in dataReaderProcedure)
									{
										...
										var dataReaderParameter = unitOfWorkContext.ExecuteDictionary(CommandType.Text, GetAllAssemblyResourceFileText(dataSourceTag, "Parameters"), new IDataParameter[]
										                                                                                                                              {
										                                                                                                                              	unitOfWorkContext.CreateParameter(ParameterDirection.Input, DbType.String, 100, 0, 0, true, "@P1", schema.SchemaName),
										                                                                                                                              ...
										                                                                                                                              }, out recordsAffected);
										{
											if ((object)dataReaderParameter != null)
											{
												foreach (var drParameter in dataReaderParameter)
												{
													...
													clrType = InferClrTypeForSqlType(dataSourceTag, parameter.ParameterSqlType);
										...
										{
											Console.Error.WriteLine(odbcex.Message); // ;)
										}
									}
								}
							}
