		...
		private object GetSchemaModel(string connectionString)
		{
			...
			using (UnitOfWorkContext unitOfWorkContext = UnitOfWorkContext.Create(connectionType, connectionString, false))
			{
				using (IDbConnection dbConnection = new SqlConnection())
				{
					...
					var dataReaderDatabase = AdoNetHelper.ExecuteDictionary(unitOfWorkContext, CommandType.Text, GetAllAssemblyResourceFileText("Database"), null, out recordsAffected);
					{
					...
					var dataReaderSchema = AdoNetHelper.ExecuteDictionary(unitOfWorkContext, CommandType.Text, GetAllAssemblyResourceFileText("Schemas"), null, out recordsAffected);
					{
						if ((object)dataReaderSchema != null)
						{
							foreach (var drSchema in dataReaderSchema)
							{
								...
								var dataReaderTable = AdoNetHelper.ExecuteDictionary(unitOfWorkContext, CommandType.Text, GetAllAssemblyResourceFileText("Tables"), new IDataParameter[] { unitOfWorkContext.CreateParameter(ParameterDirection.Input, DbType.String, 100, 0, 0, true, "@SchemaName", schema.SchemaName) }, out recordsAffected);
								{
									foreach (var drTable in dataReaderTable)
									{
										...
										var dataReaderColumn = AdoNetHelper.ExecuteDictionary(unitOfWorkContext, CommandType.Text, GetAllAssemblyResourceFileText("Columns"), new IDataParameter[]
										                                                                                                                                      {
										...
										var dataReaderForeignKey = AdoNetHelper.ExecuteDictionary(unitOfWorkContext, CommandType.Text, GetAllAssemblyResourceFileText("ForeignKeys"), new IDataParameter[]
										                                                                                                                                              {
										                                                                                                                                              	unitOfWorkContext.CreateParameter(ParameterDirection.Input, DbType.String, 100, 0, 0, true, "@SchemaName", schema.SchemaName),
										                                                                                                                                              ...
										                                                                                                                                              }, out recordsAffected);
										{
											if ((object)dataReaderForeignKey != null)
											{
												foreach (var drForeignKey in dataReaderForeignKey)
												{
													...
													var dataReaderForeignKeyColumn = AdoNetHelper.ExecuteDictionary(unitOfWorkContext, CommandType.Text, GetAllAssemblyResourceFileText("ForeignKeyColumns"), new IDataParameter[]
													                                                                                                                                                          {
													                                                                                                                                                          	unitOfWorkContext.CreateParameter(ParameterDirection.Input, DbType.String, 100, 0, 0, true, "@SchemaName", schema.SchemaName),
													                                                                                                                                                          	unitOfWorkContext.CreateParameter(ParameterDirection.Input, DbType.String, 100, 0, 0, true, "@TableName", table.TableName),
										...
										var dataReaderUniqueKey = AdoNetHelper.ExecuteDictionary(unitOfWorkContext, CommandType.Text, GetAllAssemblyResourceFileText("UniqueKeys"), new IDataParameter[]
										                                                                                                                                            {
										                                                                                                                                            	unitOfWorkContext.CreateParameter(ParameterDirection.Input, DbType.String, 100, 0, 0, true, "@SchemaName", schema.SchemaName),
										                                                                                                                                            	unitOfWorkContext.CreateParameter(ParameterDirection.Input, DbType.String, 100, 0, 0, true, "@TableName", table.TableName)
										                                                                                                                                            }, out recordsAffected);
										{
											if ((object)dataReaderUniqueKey != null)
											{
												foreach (var drUniqueKey in dataReaderUniqueKey)
												{
													...
													var dataReaderUniqueKeyColumn = AdoNetHelper.ExecuteDictionary(unitOfWorkContext, CommandType.Text, GetAllAssemblyResourceFileText("UniqueKeyColumns"), new IDataParameter[]
													                                                                                                                                                        {
													                                                                                                                                                        	unitOfWorkContext.CreateParameter(ParameterDirection.Input, DbType.String, 100, 0, 0, true, "@SchemaName", schema.SchemaName),
													                                                                                                                                                        	unitOfWorkContext.CreateParameter(ParameterDirection.Input, DbType.String, 100, 0, 0, true, "@TableName", table.TableName),
								...
								var dataReaderProcedure = AdoNetHelper.ExecuteDictionary(unitOfWorkContext, CommandType.Text, GetAllAssemblyResourceFileText("Procedures"), new IDataParameter[] { unitOfWorkContext.CreateParameter(ParameterDirection.Input, DbType.String, 100, 0, 0, true, "@SchemaName", schema.SchemaName) }, out recordsAffected);
								{
									if ((object)dataReaderProcedure != null)
									{
										foreach (var drProcedure in dataReaderProcedure)
										{
											...
											var dataReaderParameter = AdoNetHelper.ExecuteDictionary(unitOfWorkContext, CommandType.Text, GetAllAssemblyResourceFileText("Parameters"), new IDataParameter[]
											                                                                                                                                            {
											                                                                                                                                            	unitOfWorkContext.CreateParameter(ParameterDirection.Input, DbType.String, 100, 0, 0, true, "@SchemaName", schema.SchemaName),
