...
{
	[XmlElementMapping(LocalName = "For", NamespaceUri = "http://code.google.com/p/textmetal/rev3", AllowAnonymousChildren = false)]
	public sealed class ForConstruct : XmlSterileObject<ITemplateXmlObject>, ITemplateXmlObject
	{
