...
namespace TextMetal.Core.Plumbing
{
	...
	public static partial class DataType
	{
		...
		/// <summary>
		/// Checks whether two object instances are equal using the Object.Equals() method.
		/// Value coercion is performed.
		/// </summary>
		...
		/// <summary>
		/// Returns a string that represents the specified type with the format specification.
		/// If the value is null, then the default value of a zero length string is returned.
		/// </summary>
		...
		/// <summary>
		/// Converts the specified string representation to its valueType equivalent
		...
		/// <param name="result">When this method returns, contains the valueType value equivalent 
		/// contained in value, if the conversion succeeded, or null if the conversion failed.
		/// The conversion fails if the value parameter is null, is an empty string,
		/// or does not contain a valid string representation of an valueType.
		...
		/// <summary>
		/// Converts the specified string representation to its TValue equivalent
		/// and returns a value that indicates whether the conversion succeeded.
		/// </summary>
		...
		/// <param name="result">When this method returns, contains the TValue value equivalent 
		/// contained in value, if the conversion succeeded, or default(TValue) if the conversion failed.
		/// The conversion fails if the value parameter is null, is an empty string,
		/// or does not contain a valid string representation of a TValue.
		/// This parameter is passed uninitialized.</param>
		/// <returns>A boolean value of true if the value was converted successfully; otherwise, false.</returns>
